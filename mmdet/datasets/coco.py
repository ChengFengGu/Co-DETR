...
class CocoDataset(CustomDataset):
    ...
    CLASSES = (
            ...
            'crack', 'patchshadow', 'transversecrack', 'linearshadow', 'longitudinalcrack',
            'damagedboard', 'watermark', 'patchrepair', 'frustose', 'pit', 'linearrepair', 
            'stair', 'subsidence', 'rut', 'transeversecrack'
               )
