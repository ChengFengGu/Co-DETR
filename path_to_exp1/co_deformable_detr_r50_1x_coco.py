...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='data/disease/annotations/disease_train.json',
        img_prefix='/home/yzd/codes/disease_det/src/disease/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/disease/annotations/disease_val.json',
        img_prefix='/home/yzd/codes/disease_det/src/disease/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file='data/disease/annotations/disease_test.json',
        img_prefix='/home/yzd/codes/disease_det/src/disease/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
